...
class BEVSparseStridedAttentionHashIndices(Function):
    ...
    def forward(ctx, spatial_shape, attend_size, range_spec, strides, dense_map, voxel_indices):
        ...
        votr.bev_sparse_strided_attention_with_hash_wrapper(x_max, y_max, z_max, x_stride, y_stride, z_stride,
                                                            num_voxels, attend_size, num_range, hash_size,
                                                            attend_indices, voxel_indices,
                                                            dense_map, range_spec)
        return attend_indices
...
bev_sparse_strided_attention_hash_indices = BEVSparseStridedAttentionHashIndices.apply
