...
from pcdet.models.dense_heads.e2e_fusion_modules import OneNetFusionHead
...
class E2EFusionHead(nn.Module):
    def __init__(self, model_cfg, input_channels, num_class, class_names, grid_size, voxel_size,
        ...
        for num_cls in self.num_classes:
            ...
            heads.update(dict(num_classes=num_cls))
            self.tasks.append(
                OneNetFusionHead(shared_ch, heads)
            )
