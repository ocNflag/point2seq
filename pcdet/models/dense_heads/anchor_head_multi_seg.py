...
from ..backbones_2d import BaseBEVBackbone, DownHead8x
...
class AnchorHeadMultiSeg(AnchorHeadTemplate):
    def __init__(self, model_cfg, input_channels, num_class, class_names, grid_size, point_cloud_range,
        ...
        self.feature_extractor = DownHead8x(input_channels, input_channels)
    ...
    def forward(self, data_dict):
        ...
        spatial_features_2d = self.feature_extractor(spatial_features_2d)
